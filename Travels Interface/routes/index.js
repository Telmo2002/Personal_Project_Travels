...
/* GET viagem details page. */
// router.get('/viagem/:id', function(req, res) {
//   axios.get(`${env.apiAccessPoint}/getviagens/${req.params.id}`)
//     .then(response => {
//       res.render('viagem', { viagem: response.data });
//     })
//     .catch(err => {
...
router.get('/create-task', function(req, res, next) {
  res.render('create-task'); // Supondo que há um arquivo create-task.ejs
});
